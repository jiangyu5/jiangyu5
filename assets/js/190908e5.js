...
`;return(d,e)=>{const u=h("router-link");return n(),s("div",b,[_(u,{to:{path:t.path},style:m({background:i})},{default:p(()=>[o("span",f,c(t.date),1),o("span",g,c(t.title),1),(n(),s("svg",k,[o("use",{"xlink:href":t.icon},null,8,F)]))]),_:1},8,["to","style"])])}}});const B=r(w,[["__scopeId","data-v-c101cbb6"]]),y={class:"memories-nav"},M=l({__name:"MemoriesNav",setup(t){const a=[{title:"\u5BF9\u4F60\u544A\u767D",path:"/memories/said",icon:"#icon-xiaoxi",date:"2022/09/16"},{title:"\u60F3\u8BF4\u7231\u4F60",path:"/memories/love",icon:"#icon-xiaoxi",date:"2022/11/04"}];return(i,d)=>(n(),s("div",y,[(n(),s(v,null,x(a,e=>_(B,{title:e.title,path:e.path,icon:e.icon,date:e.date},null,8,["title","path","icon","date"])),64))]))}});const S=r(M,[["__scopeId","data-v-90b1bc07"]]);export{S as default};
